...
*  It implements the `UCMessageData` protocol and it contains the senderId, senderDisplayName,
...
*/
@interface UCMessage : NSObject <UCMessageData, NSCoding, NSCopying>
...
*/
@property (copy, nonatomic, readonly) id <UCMessageMediaData> media;
...
*
*  @discussion Initializing a `UCMessage` with this method will set `isMediaMessage` to `YES`.
*
*  @return An initialized `UCMessage` object if successful, `nil` otherwise.
*/
+ (instancetype)messageWithSenderId:(NSString *)senderId
                        displayName:(NSString *)displayName
                              media:(id <UCMessageMediaData>)media;
